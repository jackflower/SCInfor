...
namespace resource
{
	...
	//Metoda zwraca wskaŸnik na zasób - obiekt klasy Texture
	Texture* CResourceManager::GetTexture(const std::string& name)
	{
		return (Texture*)GetResource<Texture>(name);
	}

	//Metoda zwraca wskaŸnik na zasób - obiekt klasy Music
	Music* CResourceManager::GetMusic(const std::string& name)
	{
		return (Music*)GetResource<Music>(name);
	}

	//Metoda zwraca wskaŸnik na zasób - obiekt klasy Sound
	Sound* CResourceManager::GetSound(const std::string& name)
	{
		return (Sound*)GetResource<Sound>(name);
	}

	//Metoda zwraca wskaŸnik na zasób - obiekt klasy Font
	Font* CResourceManager::GetFont(const std::string& name)
	{
	...
	//Metoda zwraca wskaŸnik na zasób - obiekt klasy Texture
	Texture* CResourceManager::GetTexture(ResourceHandle handle)
	{
		return (Texture*)GetResource<Texture>(handle);
	}
	
	//Metoda zwraca wskaŸnik na zasób - obiekt klasy Music
	Music* CResourceManager::GetMusic(ResourceHandle handle)
	{
		return (Music*)GetResource<Music>(handle);
	}

	//Metoda zwraca wskaŸnik na zasób - obiekt klasy Sound
	Sound* CResourceManager::GetSound(ResourceHandle handle)
	{
		return (Sound*)GetResource<Sound>(handle);
	}

	//Metoda zwraca wskaŸnik na zasób - obiekt klasy Font
	Font* CResourceManager::GetFont(ResourceHandle handle)
	{
