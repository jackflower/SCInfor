...
namespace maths
{
	...
	//Metoda zwraca odleg³oœæ miêdzy dwoma punktami
	...
	//Funkcje operuj¹ce na liczbach (jakaœ interpolacja_
	...
	//Funkcje licz¹ce odleg³oœæ miêdzy figurami geometrycznymi
