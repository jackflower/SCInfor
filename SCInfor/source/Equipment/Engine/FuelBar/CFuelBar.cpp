...
namespace equipment
{
	...
	:
		CPhysical			(CFuelBarCopy),//konstruktor kopiuj¹cy klasy bazowej
	...
	//	m_timer += dt;
	//	
	//	//aktualizacja stanu paliwa ma miejsce jeœli jest paliwo
	//	if(GetFuel())
	//	{
	//		if (m_timer >= CEquipment::m_regeneration_time)		//jeœli up³yn¹³ jakiœ czas
	//		{
	//			SetFuel(GetFuel() - m_fuel_consumption);		//zu¿ywamy paliwo
