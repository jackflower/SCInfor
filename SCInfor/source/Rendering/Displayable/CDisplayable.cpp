...
// | CDisplayable.cpp - class implementation  |
...
namespace rendering
{
	namespace displayable
	{
		...
		:
			...
			p_synthetic_texture		(CDisplayableCopy.p_synthetic_texture),
			p_synthetic_image		(CDisplayableCopy.p_synthetic_image)
		{
		}
		...
		const std::string CDisplayable::GetType() const
		{
