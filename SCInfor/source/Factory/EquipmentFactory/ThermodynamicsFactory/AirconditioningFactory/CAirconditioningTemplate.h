...
namespace factory
{
	...
	public:
		...
		///
		///@param *p_airconditioning - wskaŸnik na obiekt klasy CAirconditioning
		///
	...
	private:
		...
		CThermalInsulationData		m_templ_thermalinsulation_data;		//opakowanie funkcjonalnoœci termoizolatora
