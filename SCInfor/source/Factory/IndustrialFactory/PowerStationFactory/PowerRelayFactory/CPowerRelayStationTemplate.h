...
namespace factory
{
	...
	public:
		...
		//Metoda zwraca wskaŸnik na obiekt klasy BatteryTemplate
		inline BatteryTemplate* getTemplateBattery()
		{
			return p_templ_battery;
		}

		//Metoda ustawia wskaŸnik na obiekt klasy BatteryTemplate
	...
	private:
		...
		BatteryTemplate*			p_templ_battery;				//wskaŸnik na obiekt klasy BatteryTemplate (wzorzec baterii)
