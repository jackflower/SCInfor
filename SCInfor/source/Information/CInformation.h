...
namespace information
{
	...
	public:
		...
		///
		///Metoda zwraca wskaŸnik na obiekt klasy InformationTemplate
		///
		inline InformationTemplate *GetTemplate() const { return p_template; }

		///
		///Metoda ustawia wskaŸnik na obiekt klasy InformationTemplate
		///
		///@param *p_template - wskaŸnik na obiekt klasy InformationTemplate
		///
	...
	protected:
		...
		InformationTemplate*	p_template;				//wskaŸnik na wzorzec
