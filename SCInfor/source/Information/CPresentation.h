...
namespace information
{
	namespace presentation
	{
		...
		public:
			...
			///
			///Metoda zwraca wskaŸnik na obiekt klasy CPresentationTemplate
			///
			inline CPresentationTemplate *GetTemplate() const { return p_template; }

			///
			///Metoda ustawia wskaŸnik na obiekt klasy CPresentationTemplate
			///
			///@param *p_template - wskaŸnik na obiekt klasy CPresentationTemplate
			///
		...
		private:
			...
			CPresentationTemplate*	p_template;				//wskaŸnik na wzorzec
