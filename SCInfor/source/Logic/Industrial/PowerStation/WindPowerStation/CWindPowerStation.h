...
namespace logic
{
	namespace powerstation
	{
		...
		public:
			...
			///
			///Metoda zwraca wskaŸnik na obiekt klasy CWindTurbine
			///
			CWindTurbine* getWindTurbine();
		
			///
			///Metoda ustawia wskaŸnik na obiekt klasy CWindTurbine
			///
			///@param *windturbine - wskaŸnik na obiekt klasy CWindTurbine
			///
