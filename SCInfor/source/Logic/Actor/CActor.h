...
namespace logic
{
	...
	public:
		...
		///
		///Metoda zwraca wskaŸnik na obiekt klasy CEngine
		///
		CEngine* GetEngine();

		///
		///Metoda ustawia wskaŸnik na obiekt klasy CEngine
		///
		///@param *engine - wskaŸnik na obiekt klasy CEngine
		///
		...
		///
		///@param *engine - wskaŸnik na obiekt klasy CEnergy
		///
		...
		///
		///Metoda ustawia wskaŸnik na obiekt klasy CAirconditioning
		///
		///@param *airconditioning - wskaŸnik na obiekt klasy CAirconditioning
		///
		...
		///
		///Metoda ustawia wskaŸnik na obiekt klasy CVentilator
		///
		...
		///
		///Metoda zwraca wskaŸnik na obiekt klasy CGun
		///
		CGun* GetGun();

		///
		///Metoda ustawia wskaŸnik na obiekt klasy CGun
		///
		///@param *gun - wskaŸnik na obiekt klasy CGun
		///
	...
	private:
		//metoda aktualizuje funkcjonalnoœæ CEngine
		void updateEngine(float dt);

		//metoda aktualizuje funkcjonalnoœæ CEnergy
		void updateEnergy(float dt);
		
		//metoda aktualizuje funkcjonalnoœæ CAirconditioning
		void updateAirconditioning(float dt);

		//metoda aktualizuje funkcjonalnoœæ CVentilator
		void updateVentilator(float dt);

		//metoda aktualizuje funkcjonalnoœæ CGun
