...
// | CGameProperties.h - class definition         |
...
namespace game
{
	...
	private:
		...
		float			m_time_step;			//wartoœæ kroku czasowego
		//time step:	1.f/60.f;				//60 aktualizacji na sekundê (niektóre gotowe framework'i)
		//time step:	1.f/40.f;				//40 aktualizacji na sekundê (warto j¹ zastosowaæ)
		//time step:	1.f/30.f;				//30 aktualizacji na sekundê (optymalna - stosowana)
	};
}//namespace game
