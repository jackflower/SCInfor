...
namespace mapengine
{
	...
	public:
		...
		///
		///Metoda zwraca wskaŸnik na obiekt klasy CMapPhysicalTemplate
		///
		inline CMapPhysicalTemplate *GetTemplate() const { return p_template; }

		///
		///Metoda ustawia wskaŸnik na obiekt klasy CMapPhysicalTemplate
		///
		///@param *p_template - wskaŸnik na obiekt klasy CMapPhysicalTemplate
		///
	...
	protected:
		...
		CMapPhysicalTemplate*	p_template;					//wskaŸnik na wzorzec - obiekt klasy CMapPhysical jak i te¿ pochodne tej klasy
