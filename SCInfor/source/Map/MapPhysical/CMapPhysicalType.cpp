...
namespace mapengine
{
	...
	//Metoda zwraca wskaŸnik na wzorzec fabryczny - obiekt klasy MapPhysicalTemplate
	MapPhysicalTemplate* CMapPhysicalType::GetTemplate()
	{
		return p_template;
	}
		
	//Metoda ustawia wskaŸnik na wzorzec fabryczny - obiekt klasy MapPhysicalTemplate
