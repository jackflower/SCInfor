...
namespace mapengine
{
	...
	private:
		...
		std::vector<CMapObjectType*>			m_map_object_types;			//wektor wskaŸników na obiekty fabryczne - wzorce dla obiektów mapy
		std::vector<CMapObjectDescriptor*>		m_map_object_descriptors;	//wektor wskaŸników na obiekty umieszczone na mapie
